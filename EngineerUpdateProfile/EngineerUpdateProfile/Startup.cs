...
[assembly: FunctionsStartup(typeof(EngineerUpdateProfile.Startup))]
namespace EngineerUpdateProfile
{
    public class Startup : FunctionsStartup
    {
        public override void Configure(IFunctionsHostBuilder builder)
        {
            ...
            builder.Services.AddTransient<IEngineerUpdateProfileBusiness, EngineerUpdateProfileBusiness>();
            builder.Services.AddTransient<IEngineerUpdateProfileRepository, EngineerUpdateProfileRepository>();
        }
    }
}
